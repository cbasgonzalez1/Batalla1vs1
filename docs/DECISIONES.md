...
| Los nueve hitos distinguen las dieciséis ciudades | **No**: seis comparten «manzana» y tres «catedral» | Sin una pieza propia, Varsovia, Rotterdam, Saint-Lô, Budapest y Berlín son el mismo campo con otra paleta. Ahora cada una lleva su **seña** irrepetible — la grúa del puerto, el silo, los dientes de dragón, la boca de alcantarilla (`ESCENARIOS.md` §3 quater) |
| El arco de tiro son puntos | Son **trazos girados con la tangente** | Discos redondos, todos iguales, no cuentan ni hacia dónde va el tiro ni cuánta certeza queda. Y el largo se recorta al hueco hasta el siguiente **en el vertex shader**: cocido en el atributo, al abrir plano se solapaban en un tubo continuo |
| El proyectil es un obús | Se **veía** como una bola | Llevaba un halo de 1,5 u sobre un cuerpo de 0,5: el halo tapaba la pieza entera. Halo a 0,95 y detrás, cuatro partes con cinturón, contorno propio y cinta de trazadora |
| El cráter resta un semicírculo | Resta un semicírculo **fundido en el borde** | En cuesta, el fondo del círculo vale la cota del impacto y el terreno de al lado sigue dos unidades más arriba: salía un pozo de paredes rectas, y con los estratos anclados al lecho se leía como un tajo cuadrado |
